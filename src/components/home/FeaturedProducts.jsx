...
import { Heart, ShoppingBag, Zap, Star, Grid, LayoutGrid, LayoutList } from "lucide-react";
        ...
        <Container>
          <div className="section-header">
            <h2 className="section-title">
              Featured <span className="highlight">Fragrances</span>
            </h2>
            <p className="section-subtitle">Our most popular luxury scents</p>
          </div>
      ...
      <Container>
        <div className="section-header">
          ...
          >
            ...
            <p className="section-subtitle">
              Discover our most luxurious scents
            </p>
          </motion.div>
        </div>
        ...
        <div className="featured-grid-selector-wrapper">
          <div className="featured-grid-selector">
            ...
            <span className="featured-grid-count">{featured.length} items</span>
          </div>
        </div>
                  ...
                  >
                    ...
                    >
                      <Heart
                        ...
                        color={isInWishlist(product._id) ? "#8B0000" : "#FFFFFF"}
                      />
                    </button>
