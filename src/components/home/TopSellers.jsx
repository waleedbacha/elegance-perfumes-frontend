...
import { getBestSellers } from "../../redux/slices/productSlice";
...
const TopSellers = () => {
  ...
  if (isLoading) {
    return (
      <section className="featured-section top-sellers-section">
        <Container>
          <div className="section-header">
            <h2 className="section-title">
              <Flame className="inline-icon" /> Top{" "}
              <span className="highlight">Sellers</span>
            </h2>
            <p className="section-subtitle">Our most popular fragrances</p>
          </div>
                ...
                >
                  ...
                  >
                    <div className="image-wrapper">
                      ...
                      {/* ✅ TOP SELLER BADGE - Always show for top sellers */}
                      <span className="badge top-seller">🔥 Top Seller</span>
